...
export function LifeDesignBridge() {
  ...
  return (
    <section className="border-y border-border bg-canvas-sky py-14 sm:py-16">
      <div className="mx-auto flex max-w-[1280px] flex-col items-start gap-6 px-5 sm:flex-row sm:items-center sm:gap-10 sm:px-8 lg:px-10">
        <Reveal className="flex size-14 shrink-0 items-center justify-center rounded-2xl border border-border bg-elevated text-cobalt">
        ...
        <Reveal delay={0.06}>
          ...
          <h2 className="font-editorial mt-2 text-2xl font-semibold tracking-tight text-ink sm:text-3xl">
