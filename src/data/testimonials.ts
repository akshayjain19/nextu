export type Testimonial = {
  ...
  name: string;
  role: string;
  /** Real customer portrait under /public — leave empty until official photos arrive */
  image?: string;
  /** Editorial illustration key when `image` is not set */
  avatarKey: string;
  featured?: boolean;
};

// TEMPORARY PLACEHOLDER TESTIMONIALS — REPLACE WITH COMPANY-PROVIDED CONTENT
